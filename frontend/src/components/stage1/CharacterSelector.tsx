...
const CharacterSelector: React.FC<CharacterProps> = ({cb1, cb2, idx, cb3}) => {
  ...
  return (
    <div style={{
      ...
      <div style={{
        backgroundColor: 'rgba(0, 0, 0, 0.8)', width: 360, height: 170, textAlign: 'center', color: 'white',
        paddingTop: 30, borderRadius: 10
        }}>
          <span>select character</span>
          <br />
          <span style={{fontSize: 10}}>use '←', '→', 'enter' key</span>
          <div style={{
            display: 'flex', justifyContent: 'space-evenly', marginTop: 35
          }}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
              <div className="char-1" onClick={() => {changeChar(1)}}></div>
              <span>qwer</span>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
              <div className="char-2" onClick={() => {changeChar(2)}}></div>
              <span>asdf</span>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
              <div className="char-3" onClick={() => {changeChar(3)}}></div>
              <span>zxcv</span>
            </div>
          </div>
      </div>
